...
<head>
    ...
    <!-- Estilos propios -->
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/admin/PerfilAdmin.css">
</head>
<body>
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarUser">
            <ul class="navbar-nav ms-auto align-items-center w-100">
                ...
                <div class="collapse navbar-collapse justify-content-center" id="navbarUser">
                    <ul class="navbar-nav flex-row w-100 justify-content-center align-items-center">
                        <li class="nav-item d-none d-md-block d-lg-none mx-2">
                            <a class="nav-link text-center" href="${pageContext.request.contextPath}/admin/perfil">
                ...
                <li class="nav-item d-none d-lg-block text-center">
                    <a href="${pageContext.request.contextPath}/admin/perfil" class="nav-link">
                        <i class="fas fa-user-circle"></i> Mi Perfil
                    </a>
                </li>
                <li class="nav-item d-none d-lg-block text-center">
...
<div class="perfil-container">
        ...
        <form action="<%= request.getContextPath() %>/admin/perfil" method="post" enctype="multipart/form-data">
            ...
            <% } else { %>
                <img class="foto-preview" src="https://ui-avatars.com/api/?name=<%= usuario != null ? usuario.getNombreCompleto().replace(" ", "+") : "Admin" %>&background=1976d2&color=fff" alt="Sin foto" />
            <% } %>
