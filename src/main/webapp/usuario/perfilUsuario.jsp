...
<head>
    ...
    <!-- Estilos propios -->
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/usuario/perfilUsuario.css">
</head>
<body>
...
<div class="perfil-container">
    ...
    <% } %>
    <form action="<%= request.getContextPath() %>/usuario/perfil" method="post" enctype="multipart/form-data">
        ...
        <% } else { %>
            <img class="foto-preview" src="https://ui-avatars.com/api/?name=<%= usuario != null ? usuario.getNombreCompleto().replace(" ", "+") : "Usuario" %>&background=1976d2&color=fff" alt="Sin foto" />
        <% } %>
