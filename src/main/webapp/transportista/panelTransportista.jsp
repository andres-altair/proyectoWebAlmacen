...
<head>
    ...
    <!-- Estilos propios -->
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/transportista/panelTransportista.css">
</head>
<body>
    ...
    <div class="panel-container container-fluid">
        ...
        <div class="user-info row">
            <div class="col-12">
                ...
                <span class="welcome-text">Bienvenido <span class="nombre-usuario">${transportistaNombre}</span></span>
            </div>
        </div>
