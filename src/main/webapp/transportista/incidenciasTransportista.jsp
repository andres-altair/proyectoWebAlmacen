...
<head>
    ...
    <title>Panel de Transportista</title>
    <!-- Bootstrap CSS -->
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/css/bootstrap.min.css" rel="stylesheet">
    <!-- FontAwesome para iconos -->
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0/css/all.min.css">
    <!-- Estilos propios -->
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/transportista/incidenciaTransportista.css">
</head>
<body>
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarTransportista">
                <ul class="navbar-nav ms-auto align-items-center w-100">
                    <div class="collapse navbar-collapse justify-content-center" id="navbarTransportista">
                        <ul class="navbar-nav flex-row w-100 justify-content-center align-items-center">
                            <li class="nav-item d-none d-md-block d-lg-none mx-2">
                                <a class="nav-link text-center" href="${pageContext.request.contextPath}/transportista/incidencia">
                    ...
                    <li class="nav-item d-none d-lg-block text-center">
                        <a href="${pageContext.request.contextPath}/transportista/incidencia" class="nav-link">
                            <i class="fas fa-exclamation-triangle"></i> Incidencias
                        </a>
                    </li>
                    <li class="nav-item d-none d-lg-block text-center">
   ...
   <div class="panel-container container-fluid">
    <c:if test="${not empty error}">
     ...
     <div class="d-flex justify-content-between align-items-center mb-3">
        <h2>Incidencias del Transportista</h2>
                    ...
                    <div class="modal fade" id="modalEstadoIncidencia${incidencia.id}" tabindex="-1" aria-labelledby="modalEstadoIncidenciaLabel${incidencia.id}" aria-hidden="true">
                      <div class="modal-dialog">
                        <div class="modal-content">
                          <form method="post" action="${pageContext.request.contextPath}/transportista/incidencia">
