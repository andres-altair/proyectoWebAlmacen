...
<html>
<head>
    <title>Mi Perfil Transportista</title>
    <!-- Bootstrap CSS -->
    ...
    <!-- Estilos propios -->
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/transportista/perfilTransportista.css">
</head>
<body>
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarTransportista">
                <ul class="navbar-nav ms-auto align-items-center w-100">
                    <div class="collapse navbar-collapse justify-content-center" id="navbarTransportista">
                        <ul class="navbar-nav flex-row w-100 justify-content-center align-items-center">
                            <li class="nav-item d-none d-md-block d-lg-none mx-2">
                                <a class="nav-link text-center" href="${pageContext.request.contextPath}/transportista/perfil">
                    ...
                    <li class="nav-item d-none d-lg-block text-center">
                        <a href="${pageContext.request.contextPath}/transportista/perfil" class="nav-link">
                            <i class="fas fa-user-circle"></i> Mi Perfil
                        </a>
                    </li>
                    <li class="nav-item d-none d-lg-block text-center">
...
<div class="perfil-container">
    ...
    <% } %>
    <form action="<%= request.getContextPath() %>/transportista/perfil" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input type="text" id="movil" name="movil" value="<%= usuario != null ? usuario.getMovil() : "" %>" placeholder="Número de móvil">
        </div>
        <div class="form-group">
        ...
        <% } else { %>
            <img class="foto-preview" src="https://ui-avatars.com/api/?name=<%= usuario != null ? usuario.getNombreCompleto().replace(" ", "+") : "Transportista" %>&background=1976d2&color=fff" alt="Sin foto" />
        <% } %>
    ...
    <hr>
    <h4>Datos completos del transportista</h4>
    <% if (usuario != null) { %>
